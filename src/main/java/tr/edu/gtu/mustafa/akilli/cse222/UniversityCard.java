...
public interface UniversityCard {
    ...
    int UPPER_LIMIT_STUDENT_BARCODE_NUMBER = 1000;
    /** Lower Limit for the student barcode number */
    int LOWER_LIMIT_STUDENT_BARCODE_NUMBER = 4999;
    /** Upper Limit for the academic barcode number */
    int UPPER_LIMIT_ACADEMİC_BARCODE_NUMBER = 5000;
    /** Lower Limit for the academic barcode number */
    int LOWER_LIMIT_ACADEMİC_BARCODE_NUMBER = 15000;
